...
def training_ready_button(direction):
    ...
    thread1 = threading.Thread(target=training_csv_populator, args=())
    thread1.start()
...
leftFist = PhotoImage(file='leftfist.png')

# Import right fist clipart
rightFist = PhotoImage(file='rightfist.png')
...
# Import left fist clipart
leftFist1 = PhotoImage(file='leftfist.png')
...
# Import right fist clipart
rightFist1 = PhotoImage(file='rightfist.png')
...
# Import feet clipart
feet = PhotoImage(file='feet2.png')
