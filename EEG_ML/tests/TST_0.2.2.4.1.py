'''
THIS TEST DIFFERS FROM 0.2.2.4 IN THAT: 
    - I am slicing the data by a tenth of a second 
        and taking the previous second and a a half
        (180 samples) worth of data
